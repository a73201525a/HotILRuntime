...
public class SkillItem1012 : SkillItem
{
    public SkillItem1012(int SkillID,  GameObject skill, SKillController skillController) : base(SkillID, skill, skillController)
    {
    }
